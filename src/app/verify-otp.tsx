...
const styles = StyleSheet.create({
  ...
  title: { fontSize: FontSizes.xxl, fontWeight: '800', color: COLORS.gray900, marginBottom: 8 },
  subtitle: { fontSize: FontSizes.md, color: COLORS.gray500, textAlign: 'center', marginBottom: 24 },
  resend: { marginTop: 20 },
